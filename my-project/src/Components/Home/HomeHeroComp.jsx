  ...
  return (
    <section className="relative">
      ...
      >
        <SwiperSlide>
          <div
            className="h-[600px] bg-cover bg-center flex flex-col items-start justify-center w-full font-['Gabarito'] pl-[50%] pr-[10%] cursor-pointer"
            style={{ backgroundImage: "url('/Image/hero-banner-1.jpg')" }}
          >
            <motion.h1
              initial={{ y: 50, opacity: 0 }}
              animate={controls}
              className="text-start font-bold text-[20px] sm:text-[30px] md:text-[40px] xl:text-[50px] text-[#222222]"
            >
